declare class StringUtils extends String {
    /**
     ...
     * `fromIndex`.
     */
    static lastIndexOf(str: string, searchValue: string, fromIndex?: number): number;
    /**
     ...
     */
    static includes(str: string, searchValue: string, position?: number): boolean;
    /**
     ...
     * specified value.
     */
    static startsWith(str: string, searchValue: string, position?: number): boolean;
    /**
     ...
     * value.
     */
    static endsWith(str: string, searchValue: string, position?: number): boolean;
    /**
     ...
     */
    static split(str: string, separator: string | RegExp, limit?: number): string[];
    /**
