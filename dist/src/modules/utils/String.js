...
class StringUtils extends String {
     ...
     * provided.
     */
    static indexOf(str, searchValue, fromIndex) {
     ...
     * `fromIndex`.
     */
    static lastIndexOf(str, searchValue, fromIndex) {
     ...
     */
    static includes(str, searchValue, position) {
     ...
     * specified value.
     */
    static startsWith(str, searchValue, position) {
     ...
     * value.
     */
    static endsWith(str, searchValue, position) {
